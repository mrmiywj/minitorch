...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        return [(a,b) for a,b in zip(self.parents, h.last_fn._backward(h.ctx, d_output)) if not a.is_constant()]
...
but was expecting derivative f'=%f from central difference."""
    for i, x in enumerate(scalars):
        ...
        print(str([x.data for x in scalars]), x.derivative, i, check, f)
